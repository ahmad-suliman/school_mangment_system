                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div class="card-body text-center p-4 mt-n5">
                        ...
                        @if ($student->user && $student->user->profile_photo)
                            <img src="{{ asset('storage/' . $student->user->profile_photo) }}" alt="Student Photo"
                                class="rounded-circle border border-4 border-white shadow-sm mb-3" width="130"
                        ...
                        <div class="mb-4">
                            <span class="badge bg-info text-dark px-3 py-2">
                                ...
                                {{ $student->user->getRoleNames()->first() ?? 'N/A' }}
                            </span>
                        </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header bg-success text-white rounded-top-4 py-3">
                        <h5 class="mb-0">
                            <i class="fa fa-chart-column me-2"></i> Student Grades
                        </h5>
                    </div>
                        ...
                        @if ($grades->count() > 0)
                            ...
                            @else
                                <div class="text-center py-5">
                                    ...
                                    <h5 class="fw-bold">No Grades Yet</h5>
