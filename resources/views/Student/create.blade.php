    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Create a student account and profile information.</p>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-primary text-white rounded-top-4 py-3">
                <h5 class="mb-0">
                    <i class="fa-solid fa-user-group me-2"></i> Student Registration Form
                </h5>
            </div>
                ...
                <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                                    <i class="fas fa-hashtag me-1 text-success"></i> Student ID
                                </label>
                                <input type="text" name="student_id" class="form-control rounded-3"
                                    value="{{ 'STD-' . str_pad($student_id + 1, 3, 0, STR_PAD_LEFT) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="birth_date" class="form-control rounded-3"
                                    value="{{ old('birth_date') }}" placeholder="Enter Birth Date ">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="guardian_name" class="form-control rounded-3"
                                    value="{{ old('guardian_name') }}" placeholder="Enter guardian_name">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="guardian_phone" class="form-control rounded-3"
                                    value="{{ old('guardian_phone') }}" placeholder="guardian_phone">
                            </div>
                        </div>
                    </div>
