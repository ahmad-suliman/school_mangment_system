                                            ...
                                            <div class="d-flex align-items-center">
                                                @if ($student->user && $student->user->profile_photo)
                                                    <img src="{{ asset('storage/' . $student->user->profile_photo) }}"
                                                        alt="Student Photo" class="rounded-circle border me-3"
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('students.show', $student->id) }}"
                                                        class="btn btn-sm btn-info text-white rounded-3" title="View Student">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                @endcan
                                                @can('update student')
                                                    <a href="{{ route('students.edit', $student->id) }}"
                                                        class="btn btn-sm btn-warning text-dark rounded-3" title="Edit Student">
