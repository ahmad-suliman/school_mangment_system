                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                @if ($teacher->user && $teacher->user->profile_photo)
                                                    <img src="{{ asset('storage/' . $teacher->user->profile_photo) }}"
                                                        alt="Teacher Photo" class="rounded-circle border me-3"
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <a href="{{ route('admin.teachers.show', $teacher->id) }}"
                                                    class="btn btn-sm btn-info text-light rounded-3" title="View Teacher">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.teachers.edit', $teacher->id) }}"
                                                    class="btn btn-sm btn-warning text-dark rounded-3" title="Edit Teacher">
