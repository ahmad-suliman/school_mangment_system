        ...
        <div class="card border-0 shadow-sm rounded-4">
                    ...
                    <div class="w-100" style="max-width: 320px;">
                        <div class="input-group">
                            @php
                                $user = auth()->user();
                            @endphp
                            <form action="{{ $user->hasRole('admin') ? route('admin.subjects.index') : route('student.subjects.index')}}" method="GET" class="d-flex gap-2">
            ...
            <div class="card-body p-0">
                ...
                @if ($subjects->count() > 0)
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    <a href="{{ route('admin.subjects.edit', $subject->id) }}"
                                                        class="btn btn-sm btn-warning text-dark rounded-3" title="Edit Subject">
                    ...
                    {{-- Footer --}}
                    <div
                        class="card-footer bg-white border-0 py-3 px-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
