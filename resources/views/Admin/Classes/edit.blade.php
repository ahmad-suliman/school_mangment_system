                ...
                <form action="{{ route('classes.update',$classes->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="class_name" class="form-select rounded-3" required>
                                    ...
                                    @for ($i = 1; $i <= 12; $i++)
                                        <option value="Grade{{$i}}" @selected(old('class_name', $classes->class_name) === 'Grade'.$i)>
                                            Grade {{ $i }}
                                        </option>
                                     @endfor
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="section" class="form-select rounded-3 @error('section') is-invalid @enderror"
                                    ...
                                    <option value="A" @selected(old('section', $classes->section) === 'A') >A</option>
                                    <option value="B" @selected(old('section', $classes->section) === 'B')>B</option>
                                    <option value="C" @selected(old('section', $classes->section) === 'C')>C</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="academic_year" class="form-select rounded-3" required>
                                    ...
                                    @for ($i = 0; $i < 5; $i++)
                                        ...
                                        @endphp
                                        <option value="{{ $year }}"
                                             @selected(old('academic_year', $classes->academic_year) === $year) >
                                            {{ $year }}
                                        </option>
                                    @endfor
                                </select>
                    ...
                    <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary rounded-3 px-4">
                            <i class="fas fa-save me-1"></i> Edit Class
                        </button>
                    </div>
                </form>
            </div>
