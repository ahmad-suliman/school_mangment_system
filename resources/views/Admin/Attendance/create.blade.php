    ...
    <div class="container py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                ...
                <p class="text-muted mb-0">add student attendance records.</p>
            </div>
            <div>
                <a href="{{ auth()->user()->hasRole('admin') ? route('admin.attendance.index') : route('teacher.attendance.index') }}"
                    class="btn btn-outline-secondary rounded-3">
                    <i class="fas fa-arrow-left me-1"></i> Show Attendance
                </a>
                ...
                <form action="{{ route('teacher.attendance.load') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="date" value="{{ old('date', $date ?? date('Y-m-d')) }}"
