            ...
            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="w-100" style="max-width: 320px;">
                    <div class="input-group">
                        <form action="{{ route('admin.class-subject-teachers.index') }}" method="GET" class="d-flex gap-2">

                            <input type="search" name="search" class="form-control w-100 bg-light border-0"
                                placeholder="Search Class..Subject..Teacher..." value="{{ request('search') }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <a href="{{ route('admin.class-subject-teachers.edit', $item->id) }}"
                                                    class="btn btn-sm btn-warning rounded-3" title="Edit">
                                                    <i class="fas fa-pen"></i>
                                                </a>

                                                {{-- Delete --}}
                                                <form
                                                    action="{{ route('admin.class-subject-teachers.destroy', $item->id) }}"
