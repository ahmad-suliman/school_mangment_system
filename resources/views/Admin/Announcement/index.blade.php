            ...
            <div class="card-header bg-white border-0 py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @php
                        $user = auth()->user();
                    @endphp
                    <form action="{{ $user->hasRole('admin')?route('admin.announcements.index'):route('teacher.announcements.index') }}" method="GET" class="d-flex gap-2">

                        <input type="search" name="search" class="form-control w-100 bg-light border-0"
                            placeholder="Search announcement..." value="{{ request('search') }}">
