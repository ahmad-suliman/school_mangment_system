            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body text-center p-4">
                    ...
                    <div class="d-grid gap-2 mt-4">
                        ...
                        <a href="#" class="btn btn-outline-warning rounded-3">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">{{ $user->teacher->phone ?? 'N/A' }}</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">{{ $user->teacher->specialization ?? 'N/A' }}</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">{{ $user->teacher->qualification ?? 'N/A' }}</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">{{ $user->teacher->address ?? 'N/A' }}</div>
                            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">{{ $user->student->student_id ?? 'N/A' }}</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">{{ $user->student->phone ?? 'N/A' }}</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">
                                    {{ $user->student->date_of_birth ? \Carbon\Carbon::parse($user->student->date_of_birth)->format('d M Y') : 'N/A' }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">{{ $user->student->address ?? 'N/A' }}</div>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold text-muted">
                                    <i class="fas fa-venus-mars me-1 text-success"></i> Gender
                                </label>
                                <div class="form-control bg-light rounded-3">{{ ucfirst($user->student->gender ?? 'N/A') }}</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light rounded-3">
                                    {{ $user->student->classroom->name ?? 'N/A' }}
                                </div>
                            </div>
